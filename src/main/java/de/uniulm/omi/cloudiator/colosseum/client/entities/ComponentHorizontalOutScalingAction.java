...
public class ComponentHorizontalOutScalingAction extends ComponentHorizontalScalingAction {
  ...
  public ComponentHorizontalOutScalingAction(@Nullable List<Link> link,
  ...
  public ComponentHorizontalOutScalingAction(@Nullable List<KeyValue> externalReferences,

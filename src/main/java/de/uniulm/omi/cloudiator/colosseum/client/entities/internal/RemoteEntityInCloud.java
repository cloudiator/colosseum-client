...
public class RemoteEntityInCloud extends RemoteEntity {
  ...
  public RemoteEntityInCloud(List<Link> links, String remoteId, RemoteState remoteState,
  ...
  public RemoteEntityInCloud(String remoteId, RemoteState remoteState, String providerId,
      String swordId, Long cloud, List<Long> cloudCredentials, Long owner) {
  ...
  public boolean equals(Object o) {
      ...
      if (!(o instanceof RemoteEntityInCloud)) {
          return false;
      }
      if (!super.equals(o)) {
          return false;

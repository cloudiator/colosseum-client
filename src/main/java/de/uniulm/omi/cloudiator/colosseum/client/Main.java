...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //PlatformCredential platformCredential = client.controller(PlatformCredential.class).updateOrCreate(new PlatformCredential(null, "X", "X", platform.getId(), tenant.getId()));
